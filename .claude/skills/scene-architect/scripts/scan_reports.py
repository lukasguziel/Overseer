"""Ordner rekursiv nach Scene-Reports scannen (ohne sie ganz zu lesen).

Aufruf: python scan_reports.py <ORDNER> [<ORDNER2> ...]
Erkennt Reports an 'nodes' + 'object_count'.
"""
import glob
import json
import sys
...
print("-- %d report(s) gefunden" % found)
